...
<head>
    ...
    <title>DANH SÁCH HỌC VIÊN NHẬP HỌC</title>
</head>
<body>
<style>
...
?>
    ...
    <div id="wrapper">
        <form id="form2" action="luuhocvien.php" method="post" role="form">
            ...
            <div class="form-group">
                <input type="text" name="hohocvien" id="hohocvien" value="<?php echo $row['hohocvien'];?>">
                <label for="">Họ học viên</label>
            </div>
            <div class="form-group">
                <input type="tenhocvien" name="tenhocvien" id="tenhocvien" value="<?php echo $row['tenhocvien'];?>">
            ...
            <div class="form-group">
                <input type="text" name="gioitinh" id="gioitinh" value="<?php echo $row['gioitinh'];?>">
                <label for="">Giới tính</label>
            </div>
            <div class="form-group">
                <input type="text" name="hokhau" id="hokhau" value="<?php echo $row['hokhau'];?>">
            ...
            <form id="form2" action="dshocvien.php" method="post" role="form">
